    ...
    return (
        <div className='footer' id='footer'>
            <div className='icons'>
                ...
                <div className='btn'>
                    <a href="https://wa.me/qr/FBWHHLPWKBSKE1" target='_blank'>

                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24" xmlSpace="preserve" width="30" height="30">
                        <g id="WA_Logo">
                            <g>
                ...
                <div className='btn'>
                    <a href="https://mailto:elizbaryananush68@gmail.com" target='_blank'>

                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30"><g id="_01_align_center" data-name="01 align center"><path d="M21,1H3A3,3,0,0,0,0,4V23H24V4A3,3,0,0,0,21,1ZM3,3H21a1,1,0,0,1,1,1v.667l-7.878,7.879a3.007,3.007,0,0,1-4.244,0L2,4.667V4A1,1,0,0,1,3,3ZM2,21V7.5L8.464,13.96a5.007,5.007,0,0,0,7.072,0L22,7.5V21Z" /></g></svg>
                    </a>
                </div>

                <div className='btn'>
                    <a target='_blank' href="https://github.com/elizbaryananush">
